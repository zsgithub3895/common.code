...
public class LagPhaseBehaviorLog implements Serializable{
	...
	private long lagCount;//卡顿次数
	private double playCountRate;//自然缓冲率
	
	private long lagUser;//卡顿用户数
	...
	public LagPhaseBehaviorLog(String hasID,String probeID, String deviceProvider, String platform, String provinceID, String cityID,String fwVersion,String exportId,String kPIUTCSec,String startSecond,String freezeTime,String indexTime) {
		this.hasID=hasID;
	...
	public void setLagUser(long lagUser) {
		this.lagUser = lagUser;
	}
